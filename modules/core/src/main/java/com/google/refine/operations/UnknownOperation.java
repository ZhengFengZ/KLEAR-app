...
/**
 * An operation that is unknown to the current KLEAR instance, but might be interpretable by another instance (for
 * instance, a later version of KLEAR, or using an extension).
 * 
